...
# ### process_sdg_information
# Allow the SDG data and metadata to be processed either as a batch or by individual series. 
# This function is where the majority of the work will happen. Here is a basic outline of the steps 
# that we will take:
