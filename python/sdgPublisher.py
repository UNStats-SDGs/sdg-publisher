...
def main():
    ...
    metadata_dir = r"C:/Users/L.GonzalezMorales/Documents/GitHub/sdg-publisher/FIS4SDG/json/"
    ...
    process_sdg_information(goal_code=[1],run_cleanup=False)
...
def get_seriesMetadata():
    try:
        seriesMetadata_json_data = json.load(open(metadata_dir + "/seriesMetadata.json"))
